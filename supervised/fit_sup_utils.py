...
def load_dataset(dataset_name, dataset_path="../datasets"):
    dataset = pd.read_csv(f"{dataset_path}/combinations/" + dataset_name + ".csv")

    with open(f"{dataset_path}/patterns/" + dataset_name + ".json", "r") as f:
...
def setup_data(
    ...
    combis, risks, _, _, n_dim = load_dataset(dataset, dataset_path=dataset_path)
