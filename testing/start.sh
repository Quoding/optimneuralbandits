...
python de_test_poly.py -d 50_rx_100000_combis_4_patterns_3 -t 1.1 -T 200 --warmup 10000 -o saves/testing -s 4 --valtype extrema --patience 25 --pop_n_members 256 --batch_size 512 --lds sqrt_inv --lr plateau
